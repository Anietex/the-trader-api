...
// eslint-disable-next-line max-len
const generateRandomBytes = (byteLength: any, type: any, length: any) => crypto.randomBytes(byteLength).toString(type).slice(0, length);

const generateRandomBytesAsync = async (byteLength:any, type: any, length: any) => {
...
// @ts-ignore
// eslint-disable-next-line no-shadow,max-len
const createGenerator = (generateForCustomCharacters: { (length: number, characters: string): string; (length: number, characters: string): Promise<string>; (arg0: any, arg1: string[]): any; }, generateRandomBytes: { (byteLength: number, type: string, length: number): string; (byteLength: number, type: string, length: number): Promise<string>; (arg0: number, arg1: string, arg2: any): any; }) => ({ length, type, characters }) => {
